...
const TermsOfService: React.FC = () => {
  return (
    <div className="md:w-10/12 mt-10 mb-10 pb-6 md:w-8/12 mx-auto md:h-auto text-gray-800 rounded bg-white">
      <div className="px-10">
        <h2 className="font-bold text-2xl text-center py-10">利用規約</h2>
        <p>
          この利用規約（以下，「本規約」といいます。）は、ShareMoeny（以下，「当方」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>
        <h3 className="font-bold text-xl pt-5 pb-1">第1条（適用）</h3>
        ...
        <h3 className="font-bold text-xl pt-5 pb-1">第2条（利用登録）</h3>
        <ol className="list-decimal ml-4">
          <li>
        ...
        <h3 className="font-bold text-xl pt-5 pb-1">第4条（禁止事項）</h3>
        <p>
        ...
        <h3 className="font-bold text-xl pt-5 pb-1">第9条（利用規約の変更）</h3>
        <p>
