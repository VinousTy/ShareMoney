            ...
            <TabPanel className="px-8">
              <div>
                      ...
                      monthlyIncomes.map(
                        (monthlyIncome: string, index: number) => (
                          <tr key={index}>
                            ...
                            <td>
                              <IconButton
                                onClick={() => editCost(index, monthlyIncome)}
                              >
                                <EditIcon />
                              </IconButton>
                            </td>
                ...
                {addBtn && (
                  <>
                    <div className="text-left ml-6 sm:ml-10 md:ml-9 text-gray-700 mb-1 pl-1 mt-6">
                      <label htmlFor="monthly_income" data-testid="label-name">
                        収入
                      </label>
                    </div>
                    <input
                ...
                {isAlertmonthlyIncome && (
                  <p className="text-red-500 text-xs mb-3 italic" role="alert">
